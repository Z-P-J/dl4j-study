...
public class Cartpole {
    ...
    public static void cartPole() throws IOException {
        ...
        //define thw mdp from gym (name, render)
        ...
        try {
            ...
            LogUtil.d(
                    "cartPoleError",
                    "too run the example, download and start the gym-http-api repo found at https://github.com/openai/gym-http-api."
                    );
            return;
        }
        ...
        //close thw mdp (close http)
        mdp.close();
    }

    public static void loadCartpole() throws IOException {
        //showcase serialization by using the trained agent on new similar mdp (but render it this time)
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            rewards += reward;
            LogUtil.d("Reward", "" + reward);
        }

        LogUtil.d("average", "" + (rewards / 1000));
    }
}
